...
Rules:
  ...
  - Beats at least 3s apart. Never in the first 1s. Keep the ENDING clean: place NO beat in the final ~4s — the short lands on a "FOLLOW FOR MORE" card and a boom ringing over it reads as a glitch.

Reply with ONLY a JSON object (no prose, no code fences):
{{"beats": [{{"t": <float>, "type": "boom|scratch", "why": "<5 words>"}}]}}""")
